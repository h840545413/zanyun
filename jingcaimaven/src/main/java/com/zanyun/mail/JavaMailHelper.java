...
public class JavaMailHelper {
    ...
    private String mailHost="smtp.mxhichina.com";
    private String sender_username="postmaster@zanyunjia.com";
    private String sender_password="Zanyunyunjia2017";
    
    private Properties properties = new Properties();
    /*
     * 初始化方法
     */
    public JavaMailHelper(boolean debug) {
        InputStream in = JavaMailHelper.class.getResourceAsStream("MailServer.properties");
        try {
            properties.load(in);
    ...
    public void doSendHtmlEmail(String subject, String sendHtml,String receiveUser) {
        try {
            ...
            InternetAddress from = new InternetAddress(MimeUtility.encodeWord("常州赞云")+" <"+sender_username+">");
